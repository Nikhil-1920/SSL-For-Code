...
sys.path.append(str(Path(__file__).parent.parent.parent))  # Add python_autocomplete-master to sys.path
...
from ssl_for_code.dataset.break_words import SourceCodeTokenizer
